<nav style="width: 100%;padding-right:288px" class="main-header navbar navbar-expand navbar-white navbar-light">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{url("user/home")}}" class="nav-link">User Page</a>
        </li>
    </ul>
