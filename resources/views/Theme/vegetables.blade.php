...
@section("main")
    ...
    <div class="products-breadcrumb">
        <div class="container">
            <ul>
                <li><i class="fa fa-home" aria-hidden="true"></i><a href="{{asset("user/home")}}">Home</a><span>|</span></li>
                                    ...
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/29.png")}}" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/30.png")}}" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/31.png")}}" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/32.png")}}" alt=" " class="img-responsive" /></a>
                ...
                <div class="w3ls_w3l_banner_nav_right_grid1 w3ls_w3l_banner_nav_right_grid1_veg">
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/33.png")}}" alt=" " class="img-responsive" /></a>
                    ...
                    <div class="col-md-3 w3ls_w3l_banner_left">
                        <div class="hover14 column">
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                <div class="agile_top_brand_left_grid_pos">
                                    <img src="i{{asset("images/offer.png")}}" alt=" " class="img-responsive" />
                                </div>
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/34.png")}}" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/35.png")}}" alt=" " class="img-responsive" /></a>
                            ...
                            <div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
                                ...
                                <div class="agile_top_brand_left_grid1">
                                    <figure>
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="{{asset("user/single")}}"><img src="{{asset("images/36.png")}}" alt=" " class="img-responsive" /></a>
